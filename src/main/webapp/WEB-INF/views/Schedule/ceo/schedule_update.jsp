...
function init(y,m)
{
	...
	for(var i=0; i<len; i++)
	{
		if(id.options[i].value==schedule_id)
		{
...
<form:form modelAttribute="schedule_update" name="schedule_update" method="post" action="schedule_update_ok">
	<input type="hidden" id="bno" name="bno" value="${this_schedule.bno }"/>
	<input type="hidden" name="schedule_id" id="schedule_id" value="${this_schedule.id }"/>
	
	<div style="display:inline-block;">
		<div id="cal">	</div>
			
				<div id="list">
					<h2 class="sche_text">스케줄 수정</h2>
					<hr id="list_hr">
					...
					<div class="content">
						...
						<div>
							<img src="resources/img/clock.png"> <input type="date" name="day" value="${this_schedule.day}">
						</div>
						<hr class="content_hr">
						...
						<div>
							...
							<input type="time" name="start_time" min="00:00:00" max="23:59:59" id="start_time" value="${this_schedule.start_time}">
							~ <input type="time" name="end_time" min="00:00:00" max="23:59:59" id="end_time" onclick="time()" value="${this_schedule.end_time }">
						</div>
					</div>
					...
					<div class="btn_write"> 
						<div class="img_main">
							<button type="submit" class="btn_submit">
								<img src="resources/img/btn_write2.png" width="330" height="40" alt="스케줄 수정하기">
								<span class="img_text"> 스케줄 수정하기 </span>
							</button>
						</div>
					</div>
				</div>
